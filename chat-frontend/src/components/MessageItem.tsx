	...
	return (
		<div className="flex mb-12">
			...
			<div className="flex flex-col">
				<div className="bg-white p-6 rounded-3xl rounded-bl-none w-96 shadow-sm mb-2">
					{" "}
					{/* {bg-blue-500, text-white => remitente} {bg-white, shadow-sm => cliente} */}
